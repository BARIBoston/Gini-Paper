...
##jack-knifed standard error as proposed by Bernasco & Steenbeek##
jcknf_se<-function(x) {
...
##columns 9-14 are the six measures of crime and disorder##
...
print(j)
  for (i in 1:nrow(addresses)) {
    print(i)
  addresses_jcknf[i,(j-7)]<-gini_prime(addresses[-i,j])
  }
}
...
##manually compare means of simulated data and jack-knifed data##
...
##re-construct streets based on adjusted addresses####
...
##create gini measures for addresses on streets##
...
####analysis of street-level ginis####
##approximated ginis reported in Table 4 in manuscript##
##regression model results reported in Table A1##
...
####re-construct tracts based on adjusted street counts####
...
####tract-level ginis####
##reported in Table 4##
##regression results reported in Table A2##
